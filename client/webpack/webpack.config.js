...
var configuration =
{
  ...
  entry:
  {
    // Separate "vendor" (3rd party) libraries from the application code
    // so that when the application code is updated
    // the `vendor` chunk retains its old hash
    // and therefore won't be needlessly redownloaded by website users.
